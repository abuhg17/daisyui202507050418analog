...
@Component({
  ...
  template: `
    ...
    <p>
      ...
      <img src="qr3vercel.png" width="100" alt="QR Code for Vercel" />
    </p>
    ...
    <h5>
      ...
      <img src="qr3netlify.png" width="100" alt="QR Code for Netlify" />
    </h5>
    ...
    <h3>
      ...
      <img src="qr3render.png" width="100" alt="QR Code for Render" />
    </h3>

    <h1>API Test:</h1>

    <h3>
      <a href="/api/hello" class="btn btn-ghost text-xl">api hello</a>
    </h3>
